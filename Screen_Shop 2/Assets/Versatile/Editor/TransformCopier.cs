...
public class TransformCopier : ScriptableObject 
{
	...
	static void AutoScaleTexture()
	{
		...
		{
			float tex_width=g.gameObject.GetComponent<Renderer>().sharedMaterial.mainTexture.width/200f;
			float tex_height=g.gameObject.GetComponent<Renderer>().sharedMaterial.mainTexture.height/200f;
