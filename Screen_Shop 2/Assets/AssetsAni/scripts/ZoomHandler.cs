...
public class ZoomHandler : MonoBehaviour {
	...
	void Update()
	{
		if (Input.touchCount == 2) {
			...
			itemBeingZoomed.transform.localScale = new Vector2(Mathf.Max (itemBeingZoomed.transform.localScale.x, 0.5f),Mathf.Max (itemBeingZoomed.transform.localScale.y, 0.5f));
