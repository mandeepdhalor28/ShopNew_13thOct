...
public class MSPTwitterUseExample : MonoBehaviour {
	...
	private static string TWITTER_CONSUMER_KEY = "e5nkNjUCYWVsVAapaC4ZRLH5E";
	private static string TWITTER_CONSUMER_SECRET = "eoijJC2wSFZZZKm6SDKVlcvtUP0Rqo9P1uhG0EZ1CBpFqCs4zF";
	...
	void Awake() 
	{
		...
		//SPTwitter.instance.OnUserDataRequestCompleteAction();
	...
	{
		Debug.Log("**Connect Button Cliekd"+IsAuntifivated);
		if(!IsAuntifivated) 
		{
	...
	private void OnUserDataLoaded() 
	{
		...
		Debug.Log("+++++++++++++++++++++++++Screen Name="+SPTwitter.instance.userInfo.screen_name);
		Debug.Log("++ID++"+SPTwitter.instance.userInfo.id);
		Debug.Log("++LANG++"+SPTwitter.instance.userInfo.lang);
		Debug.Log("++NAME++"+SPTwitter.instance.userInfo.name);

		string rowdata=SPTwitter.instance.userInfo.rawJSON;

		Debug.Log("++RawJson==="+rowdata);
