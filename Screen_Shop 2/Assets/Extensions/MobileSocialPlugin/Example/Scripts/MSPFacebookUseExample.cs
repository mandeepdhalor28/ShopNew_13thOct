...
public class MSPFacebookUseExample : MonoBehaviour {
	...
	private void OnUserDataLoaded()
	{
		...
		Debug.Log("||==>Email="+SPFacebook.instance.userInfo.email);
		Debug.Log("||==>Firstname="+SPFacebook.instance.userInfo.first_name +" "+SPFacebook.instance.userInfo.last_name);
		Debug.Log("||==>id="+SPFacebook.instance.userInfo.id);
		Debug.Log("||==>name="+SPFacebook.instance.userInfo.name);
		Debug.Log("||==>username="+SPFacebook.instance.userInfo.username);
		Debug.Log("||==>RowJson="+SPFacebook.instance.userInfo.rawJSON);
